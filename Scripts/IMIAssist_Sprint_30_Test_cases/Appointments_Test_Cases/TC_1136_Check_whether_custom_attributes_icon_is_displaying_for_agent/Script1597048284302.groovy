...
{
	KeywordUtil.markFailed('ERROR:Customer attribte is available for agent ')
	...
	{
	KeywordUtil.markFailed('ERROR:Customer attribte is available for agent :'+e.getMessage())
