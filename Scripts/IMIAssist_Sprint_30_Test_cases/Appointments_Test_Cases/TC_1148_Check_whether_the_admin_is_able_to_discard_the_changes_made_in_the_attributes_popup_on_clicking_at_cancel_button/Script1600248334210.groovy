...
WebUI.mouseOver(findTestObject('Object Repository/AppointmentCreationpopup/Nameattribute'))
WebUI.delay(2)
	
WebUI.click(findTestObject('Object Repository/AppointmentCreationpopup/Nameattributeadd_object'))

WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/AppointmentCreationpopup/Cancelbuttonobjectonattributepopup'))

WebUI.delay(3)
Discordmessage=WebUI.getText(findTestObject('Object Repository/AppointmentCreationpopup/Discord_message_object'))
Expectedmessage=findTestData('IMIAssist_sprint30_testdata').getValue(16, 1)

if(Discordmessage.equals(Expectedmessage))
{
	KeywordUtil.markPassed('SUCCESS:Agent able to see the discord message')
		WebUI.click(findTestObject('Object Repository/AppointmentCreationpopup/Attributediscardbutton'))
}
else
{
	KeywordUtil.markFailed('ERROR:Agent unable to see the discord message')
...
{
		KeywordUtil.markFailed('ERROR:Agent unable to see the discord message'+e.getMessage())
