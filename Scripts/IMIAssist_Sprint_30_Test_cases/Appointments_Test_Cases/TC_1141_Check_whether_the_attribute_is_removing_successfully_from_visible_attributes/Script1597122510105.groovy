...
WebUI.delay(5)
WebUI.delay(2)
WebUI.mouseOver(findTestObject('Object Repository/AppointmentCreationpopup/Clientid'))
WebUI.delay(3)
//AddedAttribute=WebUI.getAttribute(findTestObject('Object Repository/AppointmentCreationpopup/firstattributeobject'), 'title')
WebUI.click(findTestObject('Object Repository/AppointmentCreationpopup/Clientidadded'))
WebUI.delay(3)
WebUI.mouseOver(findTestObject('Object Repository/AppointmentCreationpopup/Clientid'))
WebUI.delay(1)
...
if(updatedconfirmationtext.equals(updatedconfirmationexpectedtext))
{
...
else
{
	...
	{
		KeywordUtil.markFailed('ERROR:Agent unable to remove the attribute from visible list:'+e.getMessage())
