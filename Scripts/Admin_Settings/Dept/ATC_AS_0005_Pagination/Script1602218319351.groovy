...
try {
    ...
    prevDisStatus = WebUI.verifyElementPresent(findTestObject('Admin_Settings/Dept/UserCreation/Page_Previous_Disabled'), 
        2, FailureHandling.OPTIONAL)

    nextDisStatus = WebUI.verifyElementPresent(findTestObject('Admin_Settings/Dept/UserCreation/Page_Next_Disabled'), 2, 
