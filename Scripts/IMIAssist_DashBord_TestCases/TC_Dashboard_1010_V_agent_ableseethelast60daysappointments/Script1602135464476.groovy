...
WebUI.click(findTestObject('Object Repository/DashBoard_Objects/Last30days_option'))

}

catch(Exception e)
{
	KeywordUtil.markFailed('ERROR:Agent unable to Last7days from view as drop down :'+e.getMessage())
