...
//CustomKeywords.'reusableKeywords.Reusable.Login'(findTestObject('Object Repository/DashBoard_Objects/Viewasdropdown'), 5)  
WebUI.delay(7)
WebUI.click(findTestObject('Object Repository/DashBoard_Objects/Teams_view'))

}

catch(Exception e)
{
	KeywordUtil.markFailed('ERROR:Agent unable to Teams_View from view as drop down :'+e.getMessage())
