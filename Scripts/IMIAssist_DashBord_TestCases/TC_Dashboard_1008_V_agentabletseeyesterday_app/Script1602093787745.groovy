...
WebUI.click(findTestObject('Object Repository/DashBoard_Objects/Yesterday_option_STDD'))

}

catch(Exception e)
{
	KeywordUtil.markFailed('ERROR:Agent unable to Yesterday from view as drop down :'+e.getMessage())
