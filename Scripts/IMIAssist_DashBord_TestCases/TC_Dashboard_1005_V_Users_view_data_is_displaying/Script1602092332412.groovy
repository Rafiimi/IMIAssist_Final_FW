...
WebUI.click(findTestObject('Object Repository/DashBoard_Objects/User_view'))

}

catch(Exception e)
{
	KeywordUtil.markFailed('ERROR:Agent unable to User_view from view as drop down :'+e.getMessage())
