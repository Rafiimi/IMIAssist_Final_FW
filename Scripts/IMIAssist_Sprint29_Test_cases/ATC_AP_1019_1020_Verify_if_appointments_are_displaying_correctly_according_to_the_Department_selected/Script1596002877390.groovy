...
WebUI.click(findTestObject('Page_eClinic - Video Consultations/a_Assigned (0) (1)'))
...
WebUI.click(findTestObject('Page_eClinic - Video Consultations/li_Quality Assuranc (1)'))
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/Page_eClinic - Video Consultations/div_QA-89-1'))
...
{
KeywordUtil.markFailed('ERROR:appointments are not displaying correctly according to the Department selected')
