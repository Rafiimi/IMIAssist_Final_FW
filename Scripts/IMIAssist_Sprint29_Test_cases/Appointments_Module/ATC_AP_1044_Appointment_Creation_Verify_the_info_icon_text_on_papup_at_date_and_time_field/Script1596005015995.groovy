...
contactinfoactualtext=WebUI.getAttribute(findTestObject('Object Repository/AppointmentCreationpopup/Contactinformationicon'), 'data-content')
expeccontctinfodata=findTestData('Appointment_creation_popup_Test_data').getValue(17, 1)
if(contactinfoactualtext.equals(expeccontctinfodata))
{
	KeywordUtil.markPassed('SUCCESS: Contact information icon text is matching woith expected text')
	}
else
{
	KeywordUtil.markFailed('ERROR: Contact information icon text is not matching with expected text')
	
}
WebUI.takeScreenshot('Test Cases\\IMIAssist_Automation_Test_Snapshots\\Appointment_creation/ATC_AP_1044_Appointment_Creation_Verify_the_info_icon_text_on_papup_at_date_and_time_field.png')
...
{
	KeywordUtil.markFailed('ERROR: Contact information icon text is not matching with expected text:'+e.getMessage())
	WebUI.click(findTestObject('Object Repository/AppointmentCreationpopup/Scheduleanappointmentpopupclosebutton'))
